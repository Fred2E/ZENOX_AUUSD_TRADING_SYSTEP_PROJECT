...
# === Entry Filtering/Trade Gatekeeping ===
ENTRY_FILTERS = {
    'min_primary_confs': {
        'M5': 2, 'M15': 3, 'H1': 3, 'H4': 3, 'D1': 3,
    },
    'min_score': {
        'M5': 2, 'M15': 2, 'H1': 2, 'H4': 2, 'D1': 2,
    },
    'min_confs': {
        'M5': 3, 'M15': 3, 'H1': 3, 'H4': 3, 'D1': 3,
    },
    'atr_threshold': {
        'M5': 1.0, 'M15': 1.0, 'H1': 1.5, 'H4': 2.0, 'D1': 2.0,
    },
    'trend_required': ['bull', 'bear'],
    'bias_match_required': {
        'M5': True, 'M15': True, 'H1': True, 'H4': True, 'D1': True,
    }
}

# === Trend/Bias Detection Parameters ===
TF_BIAS_PARAMS = {
...
# === Structure/Swing Detection Parameters ===
SWING_PARAMS = {
...
# === S/R and Psych Level Parameters ===
SR_LOOKBACK = {
...
# === Candle Pattern Thresholds (Adaptive) ===
CANDLE_THRESH = {
...
# === Timeframe Hierarchy Map for Regime Logic ===
HTF_MAP = {
    'M5': 'H1', 'M15': 'H4', 'H1': 'D1', 'H4': 'D1', 'D1': None
}

# === Confluence Columns (Canonical, Use for All Modules) ===
...
# === RL Training Parameters (Per Timeframe) ===
RL_TRAIN_PARAMS = {
...
# === Walkforward Backtest Thresholds ===
WALKFORWARD_PARAMS = {
